...
import DefaultSyles from '../constants/defaultStyles'
...
const GameScreen = ({userChoice, onGameOver}) => {
  ...
  const nextGuessHandler = direction => {
    if ((direction === 'lower' && currentGuess < userChoice) || (direction === 'greater' && currentGuess > userChoice)) {
      Alert.alert('Don\'t lie!', 'That is wrong hint!', [{text: 'Sorry!', style: 'cancel'}])
      return
    }
    ...
    setPastGuesses([nextNum.toString(), ...pastGuesses])
  }
      ...
      <View style={styles.screen}>
        ...
        <View style={styles.listContainer}>
          <FlatList
            ...
            renderItem={item => renderItem(pastGuesses.length, item)}
